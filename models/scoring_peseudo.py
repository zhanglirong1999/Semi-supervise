...
from model_utils import score_triples
...
def parse_args():
    ...
    group_model.add_argument("--tokenizer", default='/data/wwangbw/Lirong/Semi-supervise/models/results/roberta-base_bs32_evalstep20/best_tokenizer', type=str, 
    ...
    group_data.add_argument("--scorer_name", default='scores', type=str, required=False,
...
def main():
    ...
    (torch.load('./results/roberta-base_bs32_evalstep20/best_model_seed_401.pth'))
